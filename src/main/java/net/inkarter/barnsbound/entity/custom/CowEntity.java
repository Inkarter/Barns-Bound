...
import org.jetbrains.annotations.Nullable;
    ...
    public class CowEntity extends Animal
    {
        ...
        public CowEntity(EntityType<? extends Animal> entityType, Level level)
        {
        ...
        protected void registerGoals()
        {
            ...
            this.goalSelector.addGoal(3, new TemptGoal(this, 1.25, stack -> stack.is(ItemTags.COW_FOOD), false));//when it follows
        ...
        {
            return ModEntities.COW_DAIRY_BLACK.get().create(serverLevel);
        }
