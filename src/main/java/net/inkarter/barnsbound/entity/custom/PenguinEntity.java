...
import net.inkarter.barnsbound.entity.client.PenguinVariant;
...
public class PenguinEntity extends Animal
{
    private static final EntityDataAccessor<Integer> VARIANT =
            SynchedEntityData.defineId(PenguinEntity.class, EntityDataSerializers.INT); //for variant
    ...
    protected void registerGoals()
    {
        ...
        this.goalSelector.addGoal(3, new TemptGoal(this, 1.25, stack -> stack.is(ModItems.TOMATO), false));//when it follows
    ...
    {
        return itemStack.is(ModItems.TOMATO.get());
    }
    ...
    private void setupAnimationStates(){
        if(this.idleAnimationTimeout <= 0){
            this.idleAnimationTimeout = 20; //20 ticks for 24 ticks for 1 second
