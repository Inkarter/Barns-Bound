package net.inkarter.barnsbound.block;

import com.mojang.blaze3d.shaders.Uniform;
import net.inkarter.barnsbound.BarnsBoundMod;
import net.inkarter.barnsbound.BarnsBoundMod;
import net.inkarter.barnsbound.block.custom.MagicBlock;
...
public class ModBlocks
{
    public static final DeferredRegister.Blocks BLOCKS =
            DeferredRegister.createBlocks(BarnsBoundMod.MOD_ID);
    ...
    public static final DeferredBlock<Block> BLACK_OPAL_DEEPSLATE_ORE = registerBlock("black_opal_deepslate_ore",
            () -> new DropExperienceBlock(UniformInt.of(3,6),
                    BlockBehaviour.Properties.of().strength(4f).sound(SoundType.METAL).requiresCorrectToolForDrops()));
